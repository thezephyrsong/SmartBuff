...
SMARTBUFF_MAGE[11] = {"Brilliance Aura", 30, SMARTBUFF_CONST_SELF};
...
SMARTBUFF_PRIEST[9] = {"Shadowguard", -1, SMARTBUFF_CONST_SELF};
...
SMARTBUFF_HUNTER[4] = {"Aspect of the Wolf", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_HUNTER[5] = {"Aspect of the Monkey", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_HUNTER[6] = {"Aspect of the Wild", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_HUNTER[7] = {"Aspect of the Beast", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_HUNTER[8] = {"Aspect of the Viper", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_HUNTER_PATTERN = {"^Aspect of"};

-- Shaman
SMARTBUFF_SHAMAN = { };
SMARTBUFF_SHAMAN[1] = {"Lightning Shield", -1, SMARTBUFF_CONST_SELF};
...
SMARTBUFF_SHAMAN[7] = {"Water Shield", -1, SMARTBUFF_CONST_SELF};
SMARTBUFF_SHAMAN[8] = {"Earth Shield", -1, SMARTBUFF_CONST_SELF};
