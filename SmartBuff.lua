...
function SMARTBUFF_IsMounted()
  ...
  while (id < 16) do
    ...
    if (bIndex >= 0) then
      ...
      if (buff and icon and (
			string.find(buff, SMARTBUFF_MOUNT) or -- Same mount fix by Red Mage Joe that was used in Outfitter
			string.find(buff, "Riding") or
			string.find(buff, "Slow and steady...")
		)) then
